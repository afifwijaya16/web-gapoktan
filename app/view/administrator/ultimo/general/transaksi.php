            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <a class="btn btn-primary btn-sm"
                        href="<?=base_url();?>/administrator/general/transaksi/pelanggan">Tambah</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <table width="100%" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <td><?=$val['nama_produk'];?> | <?=$val['jumlah_pesanan'];?> x
                                                <?=rupiah($val['harga_beli']);?> =
                                                <?=rupiah($total=$val['jumlah_pesanan'] * $val['harga_beli']);?> <br>
                                            </td>
                                        </tr>
                                        <?php };?>
                                ...
                                <td><?=$row['alamat_pengiriman'];?>, <?=$row['kecamatan'];?>, <?=$row['kabupaten'];?>
                                </td>
                                ...
                                <td align="center">
                                    <a class="btn btn-primary btn-sm"
                                        href="<?=base_url();?>/administrator/general/transaksi/perbaiki/<?=$row['id_transaksi'];?>">
                                        <i class="glyphicon glyphicon-pencil"></i></a>
                                    <a class="btn btn-danger btn-sm"
                                        href="<?=base_url();?>/administrator/general/transaksi/hapus/<?=$row['id_transaksi'];?>">
...
<form method="post" action="<?=base_url();?>/administrator/general/transaksi/perbaiki/<?=$transaksi['id_transaksi'];?>"
        ...
        <div class="col-sm-12">
            <section class="panel default blue_title h4">
                <div class="panel-footer">
                    ...
                    <a class="btn btn-primary pull-right" href="<?=base_url();?>/administrator/general/transaksi">
                        Kembali <i class="glyphicon glyphicon-arrow-left"></i></a>
                </div>
            </section>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <section class="panel default blue_title h4">
                                <div class="panel-footer">
                                    <button class="btn btn-primary" type="submit"
                                        onclick="return confirm('Yakin data akan disimpan ?')"><i
                                            class="fa fa-save"></i> Next</button>
                                </div>
                            </section>
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        foreach ($produk as $row) { 
            ...
            ?>
                                        ...
                                        <form method="post"
                                            action="<?=base_url();?>/administrator/general/transaksi/keranjang/<?=url_segment(5);?>?eks=tambah">
                                    <tr>
        ...
        <!--/.col (left) -->
        <form method="post"
            action="<?=base_url();?>/administrator/general/transaksi/keranjang/<?=url_segment(5);?>?ts=<?=$pel['id_transaksi'];?>">
            <div class="col-md-4">
                <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header with-border">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            ?>
                                            <tr>
                                                ...
                                                <td><?=rupiah($sub_total=$pl['jumlah_pesanan'] * $pl['harga_beli']);?>
                                                </td>
                                                <td><a href="<?=base_url();?>/administrator/general/transaksi/keranjang/<?=url_segment(5);?>/<?=$pl['id_keranjang'];?>"
                                                        class="btn btn-danger btn-sm"
                                                        onclick="return confirm('Yakin data akan dihapus ?')"><i
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control dashed" name="alamat_pengiriman"
                                            required="required">
                                    </textarea>
                                    </div>
                        ...
                        <div class="col-sm-12">
                            <section class="panel default blue_title h4">
                                <div class="panel-footer">
                                    <a
                                        href="<?=base_url();?>/administrator/general/transaksi/perbaiki/<?=url_segment(5);?>?bayar=1">
