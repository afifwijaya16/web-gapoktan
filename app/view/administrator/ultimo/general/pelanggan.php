            ...
            <thead>
              <tr>
                ...
                <td align="center"><a class="btn btn-success btn-sm"
                    href="<?=base_url();?>/administrator/general/pelanggan/tambah/"><i
              ...
              <tr>
                ...
                <td align="center">
                  <a class="btn btn-success btn-sm"
                    href="<?=base_url();?>/administrator/general/pelanggan/perbaiki/<?=$row['id_pelanggan'];?>">
                    <i class="glyphicon glyphicon-edit"></i></a>
                  <a class="btn btn-danger btn-sm"
                    href="<?=base_url();?>/administrator/general/pelanggan/hapus/<?=$row['id_pelanggan'];?>">
              ...
              <section class="panel default blue_title h4">
                <div class="panel-footer">
                  <button class="btn btn-primary" type="submit"
                    onclick="return confirm('Yakin data akan disimpan ?')"><i class="fa fa-save"></i> Simpan</button>
                  <button class="btn btn-default" type="reset"><i class="fa fa-refresh"></i> Batal</button>
                  <a class="btn btn-primary pull-right" href="<?=base_url();?>/administrator/general/pelanggan"> Kembali
...
<?php
    ...
    {
    ?>
<form method="post" action="<?=base_url();?>/administrator/general/pelanggan/perbaiki/<?=$pelanggan['id_pelanggan'];?>"
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      <section class="panel default blue_title h4">
        <div class="panel-footer">
          <button class="btn btn-primary" type="submit" onclick="return confirm('Yakin data akan disimpan ?')"><i
              class="fa fa-save"></i> Simpan</button>
          <button class="btn btn-default" type="reset"><i class="fa fa-refresh"></i> Batal</button>
          <a class="btn btn-primary pull-right" href="<?=base_url();?>/administrator/general/pelanggan"> Kembali <i
