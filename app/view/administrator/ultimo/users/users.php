              ...
              <tr>
                ...
                <td align="center">
                  <a class="btn btn-primary btn-sm"
                    href="<?=base_url();?>/administrator/users/users/perbaiki/<?=$row['id_users'];?>">
            ...
            <div class="col-sm-12">
              <section class="panel default blue_title h4">
                <div class="panel-footer">
                  ...
                  <a class="btn btn-primary pull-right" href="<?=base_url();?>/administrator/users/users"> Back <i
...
<?php
    ...
    {
    ?>
<form method="post" action="<?=base_url();?>/administrator/users/users/perbaiki/<?=$users['id_users'];?>"
