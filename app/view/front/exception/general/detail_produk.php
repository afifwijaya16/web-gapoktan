			...
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="main-image">
						<img src="<?=base_url();?>/resources/public/images/<?=$pro['gambar_produk'];?>" class="zoom"
							alt=""
							data-zoom-image="<?=base_url();?>/resources/public/images/<?=$pro['gambar_produk'];?>" />
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="actions">
										...
										<a
											href="<?=base_url()."/front/general/statis/cart/?p=tambah&id=".$pro['id_produk'];?>&price=<?=$harga;?>">
											<button class="btn btn-lg btn-loading"><i
													class="icon icon-cart"></i><span>Beli</span></button>
											<a href="#" class="btn btn-lg product-details"><i
													class="icon icon-external-link"></i></a>
										</a>
										<?php } else { ?>

										Silahkan Melakukan Registrasi dan Login sebelum berbelanja! <a
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<label class="radio">
													<input id="vote-quality1" type="radio" name="rating" value="1"><span
														class="outer"><span class="inner"></span></span>
												</label>
											</td>
											<td class="text-center">
												<label class="radio">
													<input id="vote-quality2" type="radio" name="rating" value="2"><span
														class="outer"><span class="inner"></span></span>
												</label>
											</td>
											<td class="text-center">
												<label class="radio">
													<input id="vote-quality3" type="radio" name="rating" value="3"><span
														class="outer"><span class="inner"></span></span>
												</label>
											</td>
											<td class="text-center">
												<label class="radio">
													<input id="vote-quality4" type="radio" name="rating" value="4"><span
														class="outer"><span class="inner"></span></span>
												</label>
											</td>
											<td class="text-center">
												<label class="radio">
													<input id="vote-quality5" type="radio" name="rating" value="5"><span
														class="outer"><span class="inner"></span></span>
												</label>
											</td>
										</tr>
