...
<head>
	...
	<!-- Google Font -->
	<link href="<?=base_url();?>/resources/seiko/https://fonts.googleapis.com/css?family=Oswald:300,400,700|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i|Roboto:300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">
...
<body class="boxed">
	...
	<div class="fixed-btns">
		<!-- Back To Top -->
		<a href="<?=base_url();?>/resources/seiko/#" class="top-fixed-btn back-to-top"><i class="icon icon-arrow-up"></i></a>
		<!-- /Back To Top -->
	</div>
	<div id="wrapper">
		<!-- Page -->
		<div class="page-wrapper">
			...
			<header class="page-header variant-2 fullboxed sticky always">
				<div class="navbar" style="background: #00BFFF">
					<div class="container">
						<!-- Menu Toggle -->
						<div class="menu-toggle"><a href="<?=base_url();?>/resources/seiko/#" class="mobilemenu-toggle"><i class="icon icon-menu"></i></a></div>
						<!-- /Menu Toggle -->
...
<!-- Header Account -->
							<div class="header-link dropdown-link header-account">
								...
								<div class="dropdown-container right">
									...
									<form action="<?=base_url();?>/front/general/statis/login" method="POST">
										<input type="text" name="email" maxlength="35" class="form-control" placeholder="E-mail*">
										<input type="password"  maxlength="25" name="password" class="form-control" placeholder="Password*">
										<button type="submit" class="btn">Login</button>
									</form>
									<!-- /form -->
									<div class="title">ATAU</div>
									<div class="bottom-text">Buat <a href="<?=base_url();?>/front/general/statis/registrasi">Akun Baru</a></div>
						...
						<div class="header-link header-search header-search">
							<div class="exp-search">
								<form method="GET" action="<?=base_url();?>/front/general/statis/cari">
									<input class="exp-search-input" placeholder="Kata Kunci" type="text" name="kw" value="">
						...
						<div class="header-logo">
							<a href="<?=base_url();?>" title="Logo"><img src="<?=base_url();?>/resources/logoheader.png" width="200px" height="50px"> 
							</div>
						<!-- /Logo -->
						<!-- Mobile Menu -->
						<div class="mobilemenu dblclick">
							...
							<div class="mobilemenu-content">
								<ul class="nav">
									...
									<li><a href="<?=base_url();?>/front/general/statis/kategori/?id=Paket">Galery</a></li>
									<?php  if (shl_session::get("status") == 'Reseller') { ?> 
									<li><a href="<?=base_url();?>/front/general/statis/kategori/?id=Sparepart"> Reseller</a></li>
									<?php };?>
								...
								<div class="footer-block collapsed-mobile">
									...
									<div class="collapsed-content">
										<ul class="simple-list">
											...
											<li><i class="icon icon-close-envelope"></i>gapoktan.gadingrejo@gmail.com</a></li>
